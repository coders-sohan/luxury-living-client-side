	...
	return (
		<>
			...
			<div className="container mx-auto px-4 md:px:14 lg:px-24 py-12 md:py-16 lg:py-16">
				<div className="">
					<div className="p-8 lg:w-1/2 mx-auto border-2 border-gray-100 rounded-lg hover:border-transparent transition duration-300 ease-in-out hover:shadow-lg">
						<div className="bg-white rounded-t-lg p-8">
							...
							<div>
								<div className="flex items-center justify-center space-x-4 mt-3">
									<button className="flex items-center py-2 px-4 text-sm uppercase rounded bg-white hover:bg-gray-100 text-gray-700 border border-transparent hover:border-transparent hover:text-gray-700 shadow-md hover:shadow-lg font-medium transition transform hover:-translate-y-0.5">
										<svg
